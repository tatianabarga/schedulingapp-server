...
class Task(models.Model):
  ...
  duration = models.TimeField(null=True, blank=True) # what am i doing here??
  start_time = models.TimeField(null=True, blank=True) # what am i doing here??
  end_time = models.TimeField(null=True, blank=True) # what am i doing here?? do i need this?
